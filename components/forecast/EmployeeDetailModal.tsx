...
import { X, Clock, MessageSquare, Save } from 'lucide-react'
...
export default function EmployeeDetailModal({ employee, onClose }: EmployeeDetailModalProps) {
  ...
  const handleSave = () => {
    // TODO: 保存処理
    console.log('Save employee data:', formData)
    onClose()
  }
            ...
            <div className="border-t pt-6">
              ...
              <div className="space-y-3 mb-4 max-h-60 overflow-y-auto">
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-sm text-gray-800">システム設定完了しました。</p>
                  <p className="text-xs text-gray-500 mt-1">
                    情シス 田中 - {format(new Date(), 'yyyy/MM/dd HH:mm', { locale: ja })}
                  </p>
                </div>
              </div>
